 ...
 */
function onchange() {
    if (!options.ast || !options.astTree) {
        ...
        var ast = mdast.parse(file, Object.assign({}, options, { position: true }));
        ...
        jquery($readTree).jstree('destroy').off('.jstree').on('hover_node.jstree', function (ev, data) {
            ...
            core: {
                data: Object.assign(makeJstree(ast), {
                    state: {
                        opened: true
                    }
                }),
...
$write.focus();
}, {"wooorm/mdast@0.26.0":2,"wooorm/mdast-range@1.0.1":3,"wooorm/vfile":4,"component/debounce@1.0.0":5,"timoxley/keycode":6,"component/querystring":7,"component/event":8,"components/jquery":9,"vakata/jstree":10}],
...
}, {"ware":11,"./lib/parse.js":12,"./lib/stringify.js":13,"./lib/file.js":14,"./lib/utilities.js":15}],
...
}, {"he":18,"repeat-string":19,"./utilities.js":15,"./expressions.js":20,"./defaults.js":21}],
...
}, {"he":18,"markdown-table":22,"repeat-string":19,"./utilities.js":15,"./defaults.js":21}],
