...
function tokenizeFootnoteDefinition(eat, $0, $1, $2, $3) {
    ...
    self.shared.footnotes[$2.toLowerCase()] = token.children;
}
...
function InlineLexer(options, shared) {
    ...
    shared.footnotesAsArray = options.footnotes ?
        utilities.keys(shared.footnotes) : [];
...
function Parser(options) {
    ...
    self.block = new BlockLexer(options, self.shared);
}
...
Parser.prototype.parse = function (value) {
    ...
    self.inline = new InlineLexer(self.options, self.shared);
