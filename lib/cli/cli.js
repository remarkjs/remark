...
function help() {
    ...
    console.log();
    console.log('  See also: man 1 remark, man 3 remark, man 3 remarkplugin,');
    console.log('    man 5 remarkrc, man 5 remarkignore,');
    console.log('    man 7 remarksetting, man 7 remarkconfig,');
    console.log('    man 7 remarkplugin.');
    console.log();
}
