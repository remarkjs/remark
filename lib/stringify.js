...
function Compiler(options) {
    ...
    if (setextHeadings === null || setextHeadings === undefined) {
        options.setextHeadings = false;
    } else if (typeof setextHeadings !== 'boolean') {
        raise(setextHeadings, 'options.setextHeadings');
    }
...
compilerPrototype.heading = function (token, parent, level) {
    ...
    setextHeadings = this.options.setextHeadings;
