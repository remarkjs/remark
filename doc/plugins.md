...
*   ⚠️ This plugin is affected: **a new version is already released**
*   🔴 This plugin is affected: it’s **currently broken** and maintainers
    have been notified
...
*   ⚠️ [`remark-breaks`](https://github.com/remarkjs/remark-breaks)
...
*   ⚠️ [`remark-comment-config`](https://github.com/remarkjs/remark-comment-config)
...
*   ⚠️ [`remark-footnotes`](https://github.com/remarkjs/remark-footnotes)
    – support pandoc footnotes
*   ⚠️ [`remark-frontmatter`](https://github.com/remarkjs/remark-frontmatter)
    – support frontmatter (yaml, toml, and more)
*   ⚠️ [`remark-gemoji`](https://github.com/remarkjs/remark-gemoji)
...
*   ⚠️ [`remark-heading-gap`](https://github.com/remarkjs/remark-heading-gap)
...
*   ⚠️ [`remark-lint`](https://github.com/remarkjs/remark-lint)
    — check Markdown code style
*   ⚠️ [`remark-macro`](https://github.com/dimerapp/remark-macro)
    — support for block macros (new node types, rehype compatible)
*   ✅ [`remark-man`](https://github.com/remarkjs/remark-man)
    — serialize Markdown as man pages (roff)
*   ⚠️ [`remark-math`](https://github.com/remarkjs/remark-math)
...
*   ⚠️ [`remark-yaml-config`](https://github.com/remarkjs/remark-yaml-config)
