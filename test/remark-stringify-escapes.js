...
test('stringify escapes', function(t) {
  ...
  t.equal(
    stringify(
      u('table', [u('tableRow', [u('tableCell', [u('text', 'a|b')])])])
    ),
    '| a\\|b |\n| ---- |',
    '`|` (in cells)'
  )
  ...
  t.equal(
    stringify(u('paragraph', [u('text', '>a')])),
    '\\>a',
    '`>` (in paragraph)'
  )
  t.equal(
    stringify(u('strong', [u('text', '>a')])),
    '**>a**',
    '`>` (in non-paragraph)'
  )
  t.equal(
    stringify(u('strong', [u('text', 'a'), u('text', '>b')])),
    '**a>b**',
    '`>` (after sibling)'
  )
  t.equal(
    stringify(u('strong', [u('text', '\n'), u('text', '>b')])),
    '**\n\\>b**',
    '`>` (after newline)'
  )
  ...
  t.equal(
    stringify(u('paragraph', [u('text', '1.a')])),
    '1.a',
    '`1.` (in paragraph, without space)'
  )
  t.equal(
    stringify(u('paragraph', [u('text', '1. ')])),
    '1\\. ',
  ...
  t.equal(
    stringify(u('strong', [u('text', '1.a')])),
    '**1.a**',
    '`1.` (in non-paragraph)'
  )
  t.equal(
    stringify(u('strong', [u('text', 'a'), u('text', '1.b')])),
    '**a1.b**',
    '`1.` (after sibling)'
  )
  t.equal(
  ...
  t.equal(
    stringify('1)a', commonmark),
    '1)a',
    '`)` (commonmark, without parent)'
  )
  t.equal(
    stringify('1) ', commonmark),
    '1\\) ',
  ...
  t.equal(
    stringify(u('paragraph', [u('text', '1)a')]), commonmark),
    '1)a',
    '`1)` (in paragraph)'
  )
  t.equal(
    stringify(u('paragraph', [u('text', '1) ')]), commonmark),
    '1\\) ',
    '`1)` (in paragraph, with space)'
  )
  t.equal(
  ...
  t.equal(
    stringify(u('strong', [u('text', '1)a')]), commonmark),
    '**1)a**',
    '`1)` (in non-paragraph)'
  )
  t.equal(
    stringify(u('strong', [u('text', 'a'), u('text', '1)b')]), commonmark),
    '**a1)b**',
    '`1)` (after sibling)'
  )
  t.equal(
